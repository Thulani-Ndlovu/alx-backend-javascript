...
describe('calculateNuconstmber', () => {
  describe('SUM', () => {
    it('should return whole numbers from floating point inputs', async () => {
      const { default: calculateNumber } = await import(calculateNumber);
